...
<head>
    ...
    <script src="../../../static/js/moudles/leaverecord/leaveRecord.js"></script>
</head>
<body>
        ...
        <div class="layui-tab">
            <blockquote class="layui-elem-quote news_search">
                ...
                <div class="layui-inline">
                    ...
                    <a class="layui-btn search_btn" href="javascript:void(0)" onclick="selectRecord()" target="_self">查询</a>
                </div>
