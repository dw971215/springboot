		...
		<div class="layui-tab">
			<blockquote class="layui-elem-quote news_search">
				<div class="layui-inline">
					...
					<a  href="javascript:void(0);" class="layui-btn " onclick="selectStu()" target="_self">查询</a>
					...
					<c:forEach items="${list}" var="leaveVo" varStatus="i">
						<tr>
							...
							<td>
								...
								<%--<a class="layui-btn layui-btn-mini "><i class="iconfont icon-edit"></i> 审核通过</a>
								<a class="layui-btn layui-btn-normal layui-btn-mini"><i class="layui-icon"></i> 审核不通过</a>--%>
							</td>
						</tr>
					</c:forEach>
					</tbody>
